import numpy as np
from BayesianOptimizers.Experimental.Pavlos_per_Group import Pavlos_PerGroup
import pandas as pd
import time
...
class Pavlos_BO:
    ...
    def __init__(
        ...
        for classifier_name in configuration_space:
            ...
            self.object_per_group[classifier_name] = Pavlos_PerGroup(f= self.f,lb=None,ub=None,\
