...
class EvolutionOpt:
    ...
    def maximize(self, initial_suggest : pd.DataFrame = None, fix_input : dict = None, return_pop = False, eta= None):
        ...
        if results.shape[0] < self.pop:
            init_design_def_kwargs = {
                    ...
                    "n_configs_x_params": 0,
                    "max_config_fracs": 0.0,
                    "init_budget": self.pop - results.shape[0]
                    } 
        ...
        y = self.objective_function(results)
