...
class Pavlos_PerGroup:
    ...
    def __init__(
        ...
        acq_funct = 'EI',
        model = 'RF',
        maximizer  = 'Sobol',group_name = '',n_folds = 10
    ):
    ...
    def pass_current_configurations_on_ACQ(self,eta):
        X_candidates = self.X 
        

        #y = self.objective_function(X_candidates,eta =eta)
        self.acquisition_function.update(eta)
        y = self.acquisition_function(X_candidates)
