...
class Switch_per_group:
    ...
    def __init__(
        ...
        self.RF = Simple_RF(self.config_space,rng=random_seed,n_estimators=100)
        self.GP = GaussianProcess(self.config_space,seed=random_seed)
    ...
    def detect_flip(self):
        return (self.n_evals > 200)

    def flip_surrogate(self):
        self.model = self.RF
