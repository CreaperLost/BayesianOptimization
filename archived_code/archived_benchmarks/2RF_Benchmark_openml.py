...
import openml
import pandas as pd
from benchmarks.RandomForestBenchmark import RandomForestBenchmarkBB_2
import argparse
...
def run_experiment_local_Smac():
    ...
    parent_path = os.getcwd() + '\Results_Unrestricted'
    ...
    for task_id in task_ids:
        ...
        for seed in [1,2,3]:
            ...
            b = RandomForestBenchmarkBB_2(task_id=task_id,rng=seed)
            cs = b.get_configuration_space()
