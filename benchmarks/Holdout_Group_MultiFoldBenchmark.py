...
from benchmarks.Holdout_Group_MultiFold_MLBenchmark import HoldOut_Group_MultiFold_MLBenchmark
...
class Holdout_Group_MultiFold_Space(HoldOut_Group_MultiFold_MLBenchmark):
    def __init__(self,
                 task_id: int,
        ...
        super(Holdout_Group_MultiFold_Space, self).__init__(task_id, rng, data_path,data_repo,use_holdout)
