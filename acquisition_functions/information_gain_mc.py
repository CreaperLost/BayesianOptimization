...
from initial_design.initial_random_uniform import initial_random_uniform
from util import mc_part
...
class InformationGainMC(BaseAcquisitionFunction):
    ...
    def sample_representer_points(self):
        ...
        start_points = initial_random_uniform(self.lower, self.upper, self.Nb)
