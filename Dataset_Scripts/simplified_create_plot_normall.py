...
def save_figure(data_repo, dataset, time_plot_bool, clf_name):
    ...
    try:
        ...
        pass
    plt.savefig(parse_directory([results_directory,clf_name+'-Normal.png']),bbox_inches='tight')
...
optimizers = ['Random_Search','Mango2','Optuna','SMAC','RF_Local','HyperOpt','Optuna2']
opt_colors = dict()
clr_pos = 0
